       ...
       (:cat1 (ht (:title "Choose #+Setupfile:")
                  (:items (list
                           (ht (:id 1)
                               ...
                               (:choices '(())))
                           (ht (:id 2)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/comfy_inline.theme"))
                               (:choices '(())))
                           (ht (:id 3)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/darksun.theme"))
                               (:choices '(())))
                           (ht (:id 4)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/imagin_light.theme"))
                               (:choices '(())))
                           (ht (:id 5)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/readtheorg_inline.theme"))
                               (:choices '(())))
                           (ht (:id 6)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/rethink_inline.theme"))
                               (:choices '(())))
                           (ht (:id 7)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/retro_dark.theme"))
                               (:choices '(())))
                           (ht (:id 8)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/simple_gray.theme"))
                               (:choices '(())))
                           (ht (:id 9)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/simple_inline.theme"))
                               (:choices '(())))
                           (ht (:id 10)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/simple_white.theme"))
                               (:choices '(())))
                           (ht (:id 11)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/simple_whiteblue.theme"))
                               (:choices '(())))
                           (ht (:id 12)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/solarized_dark.theme"))
                               (:choices '(())))
                           (ht (:id 13)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/solarized_light.theme"))
                               (:choices '(())))
                           (ht (:id 14)
                               (:template (concat "#+Setupfile: " (file-name-directory load-file-name) "org-exsty/styles-html/stylish_white.theme"))
                               (:choices '(())))))))
       (:cat57 (ht (:title "Choose #+Pandoc-Options:")
                   (:items (list
                            (ht (:id 21)
                                (:template "#+Pandoc-Options: reference-doc:~/.Semacs/modules/org-exsty/styles-doc/light_blue.docx")
                                (:choices '(())))
                            (ht (:id 22)
                                (:template "#+Pandoc_Options: reference-doc:~/.Semacs/modules/org-exsty/styles-doc/red_black.docx")
                                (:choices '(())))))))))
